...
output "api_key" {
  value = nonsensitive(aws_api_gateway_api_key.mykey.value)
  description = "To be used with  x-api-key in header to test via postman"
}
output "invoke_arn" { value = "${aws_api_gateway_deployment.api.invoke_url}"}
output "stage_name" { value = "${aws_api_gateway_stage.example.stage_name}"}
output "path_part" { value = "${aws_api_gateway_resource.form_score.path_part}"}
output "complete_url" { value = "${aws_api_gateway_deployment.api.invoke_url}${aws_api_gateway_stage.example.stage_name}/${aws_api_gateway_resource.form_score.path_part}"}